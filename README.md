...
Plex Assistant currently supports the following languages when using DialogFlow: English `en`, Swedish `sv`, Dutch `nl`, French `fr`, and Italian `it`. [Help add translations.](translation.md)
