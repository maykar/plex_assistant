...
Please, also consider translating the `README.md` file and `custom_components/plex_assistant/en.json` to a new file with the language code added to the file name. Example: `README_NL.md` and `custom_components/plex_assistant/nl.json`.
